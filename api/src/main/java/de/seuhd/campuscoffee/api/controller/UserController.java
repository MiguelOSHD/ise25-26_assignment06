    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(
                            ...
                            description = "Validation failed (e.g., invalid login name, or bean validation errors)."
                    )
            }
    )
    @PostMapping("")
    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(
                            ...
                            description = "Validation failed: IDs in path and body do not match, invalid login name, or bean validation errors."
                    ),
                    @ApiResponse(
                            responseCode = "404",
                            content = @Content(
